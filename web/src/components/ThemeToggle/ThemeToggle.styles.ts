...
export const themeToggleStyles = {
  ...
  // Expanded popover styles (fixed positioning for portal)
  popover: "fixed z-[1250] p-4 rounded-lg border shadow-lg transition-all duration-300",
  ...
  // Backdrop (below header z-[1100], above content)
  backdrop: "fixed inset-0 z-[1000] transition-opacity duration-300",
} as const;
