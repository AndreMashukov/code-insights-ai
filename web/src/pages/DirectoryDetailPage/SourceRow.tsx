    ...
    <div className="group rounded-lg border border-border p-3 hover:bg-muted/50 transition-colors flex items-center gap-3">
      ...
      <div className="flex items-center gap-1 shrink-0">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-7 w-7 opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity text-muted-foreground hover:text-destructive"
          onClick={(e) => {
            e.stopPropagation();
            onDelete(document);
          }}
