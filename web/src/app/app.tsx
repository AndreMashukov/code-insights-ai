          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-8">
                <div className="flex items-center bg-card rounded-lg p-4 shadow-md border border-border">
                  ...
                  <div className="text-left">
                    <p className="font-semibold text-foreground">URL to Quiz</p>
                    <p className="text-sm text-muted-foreground">Instant conversion</p>
                  </div>
                </div>
                ...
                <div className="flex items-center bg-card rounded-lg p-4 shadow-md border border-border">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">Smart question generation</p>
                  </div>
                </div>
                ...
                <div className="flex items-center bg-card rounded-lg p-4 shadow-md border border-border">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-muted-foreground">Export & share easily</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <Routes>
              <Route
                ...
                element={
                  <div className="space-y-8">
                    <div className="text-center">
                      <div className="mx-auto w-14 h-14 bg-accent rounded-xl flex items-center justify-center mb-6 shadow-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                      <div className="bg-card rounded-xl p-6 shadow-md border border-border hover:shadow-lg transition-all duration-200 smooth-transition">
                        <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4">
                          <Icon size={24} className="text-primary">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                          </Icon>
                        </div>
                        <h3 className="text-lg font-semibold text-foreground mb-2">Create Quiz</h3>
                        <p className="text-muted-foreground mb-4 text-sm">Generate a new quiz from any web URL using AI-powered content analysis.</p>
                        <button className="w-full py-2 px-4 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 smooth-transition font-medium">
                          Start Creating
                        </button>
                      </div>
                      ...
                      <div className="bg-card rounded-xl p-6 shadow-md border border-border hover:shadow-lg transition-all duration-200 smooth-transition">
                        ...
                        <h3 className="text-lg font-semibold text-foreground mb-2">My Quizzes</h3>
                        <p className="text-muted-foreground mb-4 text-sm">View and manage all your previously created quizzes in one place.</p>
                        <button className="w-full py-2 px-4 bg-accent text-accent-foreground rounded-lg hover:bg-accent/90 smooth-transition font-medium">
                          View Quizzes
                        </button>
                      </div>
                      ...
                      <div className="bg-card rounded-xl p-6 shadow-md border border-border hover:shadow-lg transition-all duration-200 smooth-transition">
                        ...
                        <p className="text-muted-foreground mb-4 text-sm">Track quiz performance and user engagement with detailed analytics.</p>
                        <button className="w-full py-2 px-4 bg-secondary text-secondary-foreground rounded-lg hover:bg-secondary/80 smooth-transition font-medium">
                          View Stats
                        </button>
                      </div>
                    </div>                    <UserProfile />
